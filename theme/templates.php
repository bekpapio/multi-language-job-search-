<?php
// include_once('language/config/langConfig.php');
include_once('language/config/selectLang.php');
?>
 <!DOCTYPE html>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+251) 928-942-334</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php?lang=<?php echo $_SESSION['lang'] ?>">Website Name <!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="<?php echo !isset($_GET['q'])? 'active' :''?>"><a href="index.php?lang=<?php echo $_SESSION['lang'] ?> "><?php echo $translations['Home'] ?> </a></li> 
                        <li class="dropdown">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle" name="language"><?php echo $translations['Languages'] ?>  <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                              <li class="<?php  if(isset($_SESSION['lang'])) { if($_SESSION['lang']=='en'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="index.php?lang=en"> <?php echo $translations['English'] ?></a></li>
                              <li class="<?php  if(isset($_SESSION['lang'])) { if($_SESSION['lang']=='om'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="index.php?lang=om"> <?php echo $translations['Afaan Oromoo'] ?></a></li>
                              <li class="<?php  if(isset($_SESSION['lang'])) { if($_SESSION['lang']=='am'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="index.php?lang=am"> <?php echo $translations['Amharic'] ?></a></li>
                    </ul></li>
                        <li class="dropdown">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle"><?php echo $translations['Job Search'] ?> <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                              <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='advancesearch'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=advancesearch&&lang=<?php echo $_SESSION['lang'] ?>"><?php echo $translations['Advance Search'] ?></a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company&&lang=<?php echo $_SESSION['lang'] ?>"><?php echo $translations['Job By Company'] ?> </a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function&&lang=<?php echo $_SESSION['lang'] ?>">Job By Function</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle&&lang=<?php echo $_SESSION['lang'] ?>">Job By Title</a></li>
                          </ul>
                       </li> 
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle"><?php echo $translations['Popular Jobs'] ?> <b class="caret"></b></a>
                          <ul class="dropdown-menu">
                            <?php 
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='company'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=company&&lang=<?php echo $_SESSION['lang'] ?>"> <?php echo $translations['Company'] ?></a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring&&lang=<?php echo $_SESSION['lang'] ?>"> <?php echo $translations['Hiring Now'] ?></a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='About'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=About&&lang=<?php echo $_SESSION['lang'] ?>"> <?php echo $translations['ABOUT US'] ?></a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='Contact'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=Contact&&lang=<?php echo $_SESSION['lang'] ?>"> <?php echo $translations['CONTACT'] ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <p>
            <i class="icon-phone"></i> (+251) 928-942 -334 <br>
            <i class="icon-envelope-alt"></i> tolchakate@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php?lang=<?php echo $_SESSION['lang'] ?>">Home</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=company&&lang=<?php echo $_SESSION['lang'] ?>">Company</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=hiring&&lang=<?php echo $_SESSION['lang'] ?>">Hiring</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=About&&lang=<?php echo $_SESSION['lang'] ?>">About us</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=Contact&&lang=<?php echo $_SESSION['lang'] ?>">Contact us</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; tkCoders 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="social-network">
            ...
            <li><a href="https://www.google.com/" data-placement="top" title="Google plus"><i class="fa fa-google-plus"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
...
<!-- <script src="<?php echo web_root; ?>plugins/paralax/paralax.js"></script>  -->
 ...
 <script type="text/javascript">
  ...
  //   window.location.href='http://localhost/job%20search/index.php/?language='+language;
